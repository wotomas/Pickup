 ...
 */
public class CustomDistanceFragmentAdapter extends BaseAdapter {
    Context _context;
    LayoutInflater _inflater;
    ArrayList<Match> _matchList;
    int _layout;

    public CustomDistanceFragmentAdapter(Context _context, LayoutInflater _inflater, ArrayList<Match> _matchList, int _layout) {
