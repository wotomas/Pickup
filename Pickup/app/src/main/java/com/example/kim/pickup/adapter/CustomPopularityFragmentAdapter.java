...
public class CustomPopularityFragmentAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        priorityOne.setText(String.valueOf(_matchList.get(position).getPopularity() + " " + _matchList.get(position).getUsersCount()) + "/" + String.valueOf(_matchList.get(position).getTotalCapacity()));
        ...
        priorityThree.setText(String.valueOf(Double.parseDouble(decim.format(matchLocation.distanceInKilometersTo(myLocation))))+"km");
